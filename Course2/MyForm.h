...
private: System::Void button10_Click(System::Object^ sender, System::EventArgs^ e) 
{
	...
	MessageBox::Show("Элемент успешно добавлен в список! ", "Сообщение", MessageBoxButtons::OK, MessageBoxIcon::Information);
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	if (currentNode != nullptr) {
		...
		else MessageBox::Show("Дальше нет экскурсий", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}
	else MessageBox::Show("Дальше нет экскурсий", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
}
...
{
	MessageBox::Show("Удаление элемента списка не предусмотрено вариантом", "Информация", MessageBoxButtons::OK, MessageBoxIcon::Information);
}
...
// SORT
	private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		Head = NewHead;
		Tail = NewTail;
		MessageBox::Show("Список успешно отсортирован!", "Информация", MessageBoxButtons::OK, MessageBoxIcon::Information);
	}
